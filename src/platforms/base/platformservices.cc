...
bool QUbuntuBasePlatformServices::openUrl(const QUrl &url)
{
    return callDispatcher(url);
}

bool QUbuntuBasePlatformServices::openDocument(const QUrl &url)
{
    return callDispatcher(url);
}

bool QUbuntuBasePlatformServices::callDispatcher(const QUrl &url)
{
