...
public:
    ...
    void setScreenModel(const QSharedPointer<ScreenModel> &sc) override
    {
        m_screenModel = sc;
    }
    ...
    {
        return m_screenModel->getWindowForPoint(point);
    }
                          ...
                          Qt::KeyboardModifiers modifiers) override
    {
        ...
        QList<Screen*> screens = m_screenModel->screens();
...
QtEventFeeder::QtEventFeeder(const QSharedPointer<ScreenModel> &screenModel)
    : QtEventFeeder(screenModel, new QtWindowSystem)
{
}
    ...
    : mQtWindowSystem(windowSystem)
{
    ...
    mQtWindowSystem->setScreenModel(screenModel);
