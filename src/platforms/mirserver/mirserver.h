...
public:
    MirServer(int argc, char const* argv[], const QSharedPointer<qtmir::ScreenController> &, QObject* parent = 0);
    ~MirServer() = default;
...
private:
    ...
    const QSharedPointer<qtmir::ScreenController> m_screenController;
};
