...
public:
    ...
    virtual void hoverEnterEvent(QHoverEvent *event, qreal dpr = 1.0) = 0;
    virtual void hoverLeaveEvent(QHoverEvent *event, qreal dpr = 1.0) = 0;
    virtual void hoverMoveEvent(QHoverEvent *event, qreal dpr = 1.0) = 0;
    virtual void wheelEvent(QWheelEvent *event, qreal dpr = 1.0) = 0;
    ...
    virtual void touchEvent(Qt::KeyboardModifiers qmods,
            ...
            ulong qtTimestamp, qreal dpr = 1.0) = 0;
