...
public:
    ...
    void hoverEnterEvent(QHoverEvent *event, qreal dpr) override;
    void hoverLeaveEvent(QHoverEvent *event, qreal dpr) override;
    void hoverMoveEvent(QHoverEvent *event, qreal dpr) override;
    void wheelEvent(QWheelEvent *event, qreal dpr) override;
    ...
    void touchEvent(Qt::KeyboardModifiers qmods,
            ...
            ulong qtTimestamp, qreal dpr) override;
