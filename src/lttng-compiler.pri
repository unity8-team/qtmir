...
lttng_gen_tp_header.commands = /usr/bin/lttng-gen-tp -o ${QMAKE_FILE_OUT} ${QMAKE_FILE_IN}
...
lttng_gen_tp_sources.commands = /usr/bin/lttng-gen-tp -o ${QMAKE_FILE_OUT} ${QMAKE_FILE_IN}
