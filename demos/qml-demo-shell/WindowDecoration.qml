...
Item {
    ...
    property alias canBeClosed: windowControlButtons.canBeClosed
    property alias canBeMinimized: windowControlButtons.canBeMinimized
    property alias canBeMaximized: windowControlButtons.canBeMaximized
