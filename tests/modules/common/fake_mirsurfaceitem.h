...
public:
    ...
    Globals::SurfaceType type() const override { return Globals::Normal; }
    Globals::SurfaceState state() const override { return m_state; }
    ...
    Globals::OrientationAngle orientationAngle() const override { return Globals::Angle0; }
    ...
    void setOrientationAngle(Globals::OrientationAngle) override {
    }
    ...
    void setState(Globals::SurfaceState state) {
        if (m_state != state) {
            m_state = state;
            Q_EMIT stateChanged();
        }
