...
public:
    ...
    void mousePressEvent(QMouseEvent *, qreal) override {}
    void mouseMoveEvent(QMouseEvent *, qreal) override {}
    void mouseReleaseEvent(QMouseEvent *, qreal) override {}
    void hoverEnterEvent(QHoverEvent *, qreal) override {}
    void hoverLeaveEvent(QHoverEvent *, qreal) override {}
    void hoverMoveEvent(QHoverEvent *, qreal) override {}
    void wheelEvent(QWheelEvent *, qreal) override {}
    ...
    void touchEvent(Qt::KeyboardModifiers mods,
            const QList<QTouchEvent::TouchPoint> &points,
            Qt::TouchPointStates states,
            ulong timestamp, qreal) override {
