...
TEST_F(QtEventFeederTest, GenerateMissingTouchEnd)
{
    ...
    mev::add_touch(*ev1, /* touch ID */ 0, mir_touch_input_event_action_down, mir_touch_input_tool_type_unknown,
                   10, 10, 10, 1, 1, 10);
    ...
    mev::add_touch(*ev2, 1 /* touch ID */, mir_touch_input_event_action_down, mir_touch_input_tool_type_unknown,
                   10, 10, 10, 1, 1, 10);
...
TEST_F(QtEventFeederTest, PressSameTouchTwice)
{
    ...
    mev::add_touch(*ev2, /* touch ID */ 0, mir_touch_input_event_action_down, mir_touch_input_tool_type_unknown,
                   10, 10, 10, 1, 1, 10);
    qtEventFeeder->dispatch(*ev2);
