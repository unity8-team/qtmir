...
TEST_F(QtEventFeederTest, GenerateMissingTouchEnd)
{
    ...
    auto ev1 = mev::make_event(MirInputDeviceId(), std::chrono::milliseconds(123), 0, 0);
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::milliseconds(125), 0, 0);
...
TEST_F(QtEventFeederTest, GenerateMissingTouchEnd2)
{
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::milliseconds(124), 0, 0);
    ...
    auto ev3 = mev::make_event(MirInputDeviceId(), std::chrono::milliseconds(125), 0, 0);
...
TEST_F(QtEventFeederTest, PressSameTouchTwice)
{
    ...
    auto ev2 = mev::make_event(MirInputDeviceId(), std::chrono::milliseconds(123), 0, 0);
